...
const AccordionRightCardSection: React.FC<AccordionRightCardSectionProps> = ({
  ...
  ref={ref}
  style={{
    // margin: "40px 0", // Yukarıdan ve aşağıdan boşluk kaldırıldı
    ...animationStyle,
    ...(inView ? visibleStyle : {}),
  }}
    ...
    {accordian.map((item, index) => (
      <div key={index} className="w-full">
        <div
          ...
          className="mb-4 cursor-pointer w-full bg-transparent border-b border-gray-300" // mb-8'den mb-4'e düşürüldü
